...
def create_presentation():
    ...
    # ==========================================
    # SLIDE 19: TABELA COMPARATIVA DE GANHOS
    # ==========================================
    slide19 = prs.slides.add_slide(blank_layout)
    set_slide_background(slide19, LIGHT_BG)
    add_header(slide19, "Métricas de Sucesso & Tabela Comparativa de Ganhos", "BLOCO 4 — DEMONSTRAÇÃO & RESULTADOS", "Equipe Integrada")

    # Table
    tbl = slide19.shapes.add_table(rows=5, cols=4, left=Inches(0.6), top=Inches(1.4), width=Inches(12.0), height=Inches(4.5)).table
    ...
    # ==========================================
    # SLIDE 20: CONCLUSÃO E ENCERRAMENTO
    # ==========================================
    slide20 = prs.slides.add_slide(blank_layout)
    set_slide_background(slide20, LIGHT_BG)
    add_header(slide20, "Conclusão & Defesa do Projeto", "BLOCO 4 — DEMONSTRAÇÃO & RESULTADOS", "Equipe Integrada")

    add_card(slide20, 0.6, 1.4, 5.8, 5.2, "Atendimento a 100% dos Requisitos do Roteiro 10", [
    ...
    add_card(slide20, 6.8, 1.4, 5.8, 5.2, "Muito Obrigado! Pergunta & Resposta (Q&A)", [
