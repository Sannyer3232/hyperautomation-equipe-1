...
<body>
    <div class="slide-container">
        ...
        <div class="slide">
            ...
            <div class="content-grid-2">
                <div class="card">
                    <div class="card-title">Estrutura do Diagrama BPMN 2.0 (Draw.io)</div>
                    <div class="card-item"><strong>• Evento Inicial:</strong> Recebimento de solicitação por e-mail.</div>
                    <div class="card-item"><strong>• Atividades Automatizadas:</strong> Geração DOCX -> Disparo SMTP -> Monitoramento IMAP -> Extração -> Validação PDF -> Cadastro Web Playwright -> Sync Drive.</div>
                    <div class="card-item"><strong>• Pontos de Decisão (Gateway):</strong> Documentação Válida? (Sim -> Documentos_OK / Não -> Documentos_Pendentes).</div>
                    <div class="card-item"><strong>• Eventos Finais:</strong> Confirmação enviada e PDF transferido para Encaminhados.</div>
                </div>
                <div class="card">
                    <div class="card-title">Principais Ganhos do Modelo TO-BE</div>
                    <div class="card-item"><strong>• Autonomia Total:</strong> Eliminação de intervenção humana na triagem e digitação.</div>
                    <div class="card-item"><strong>• Regras Estritas:</strong> Rejeição imediata de arquivos sem assinatura.</div>
                    <div class="card-item"><strong>• Sincronização em Nuvem:</strong> Atualização remota instantânea no Google Drive.</div>
                </div>
            </div>
            <div class="footer">
                <span>Empresa Portal Fake — Processo 1</span>
                <span>Slide 6 de 20</span>
            </div>
        </div>
        ...
        <div class="slide">
            <div class="header">
                <div class="header-title-box">
                    ...
                    <div>
                        <div class="category">Bloco 4 — Demonstração & Resultados</div>
                        <div class="title">Evidências Práticas: Portal Fake & Screenshots</div>
                    </div>
                </div>
                <div class="member-badge">Equipe Integrada</div>
            </div>
            <div class="content-grid-2">
                <div class="card">
                    <div class="card-title">Figura 2: Portal ERP Preenchido</div>
                    <div class="card-item"><strong>• Playwright RPA:</strong> Registros cadastrais inseridos dinamicamente na interface web do Portal Fake.</div>
                </div>
                <div class="card">
                    <div class="card-title">Figura 3: Ativação de Cadastro</div>
                    <div class="card-item"><strong>• Status no Sistema:</strong> Transição automática para o estado 'ATIVO' após validação completa.</div>
                </div>
            </div>
            <div class="footer">
                <span>Empresa Portal Fake — Processo 1</span>
                <span>Slide 18 de 20</span>
            </div>
        </div>

        <!-- SLIDE 19: EVIDÊNCIAS DE E-MAIL -->
        <div class="slide">
            <div class="header">
                <div class="header-title-box">
                    <div class="red-bar"></div>
                    <div>
                        <div class="category">Bloco 4 — Demonstração & Resultados</div>
                        <div class="title">Evidências Práticas: Confirmação & Pendências de E-mail</div>
                    </div>
                </div>
                <div class="member-badge">Equipe Integrada</div>
            </div>
            <div class="content-grid-3">
                <div class="card" style="text-align: center;">
                    <div class="card-title">✅ Confirmação de Sucesso</div>
                    <img src="../img/sucesso.png" style="max-width: 100%; border-radius: 6px; border: 1px solid var(--card-border); margin: 8px 0;" alt="Sucesso">
                    <div class="card-item"><strong>Status:</strong> E-mail HTML de cadastro aprovado e ativado no ERP.</div>
                </div>
                <div class="card" style="text-align: center;">
                    <div class="card-title">⚠️ Pendência: Doc. Foto</div>
                    <img src="../img/falha_faltou_documento_foto.png" style="max-width: 100%; border-radius: 6px; border: 1px solid var(--card-border); margin: 8px 0;" alt="Faltou Foto">
                    <div class="card-item"><strong>Status:</strong> E-mail notificando ausência de Documento com Foto.</div>
                </div>
                <div class="card" style="text-align: center;">
                    <div class="card-title">⚠️ Pendência: Comprovante</div>
                    <img src="../img/falha_falta-comprovante-residencia.png" style="max-width: 100%; border-radius: 6px; border: 1px solid var(--card-border); margin: 8px 0;" alt="Falta Comprovante">
                    <div class="card-item"><strong>Status:</strong> E-mail notificando ausência de Comprovante de Residência.</div>
                </div>
            </div>
            <div class="footer">
                <span>Empresa Portal Fake — Processo 1</span>
                <span>Slide 19 de 21</span>
            </div>
        </div>

        <!-- SLIDE 20: TABELA COMPARATIVA -->
        <div class="slide">
            <div class="header">
                <div class="header-title-box">
                    <div class="red-bar"></div>
