        ...
        <div class="slide">
            <div class="header">
                <div class="header-title-box">
                    ...
                    <div>
                        <div class="category">Bloco 4 — Demonstração & Resultados</div>
                        <div class="title">Evidência 1: Confirmação de Cadastro Aprovado (E-mail HTML)</div>
                    </div>
                </div>
                <div class="member-badge">Equipe Integrada</div>
            </div>
        ...
        <div class="slide">
            <div class="header">
                <div class="header-title-box">
                    ...
                    <div>
                        <div class="category">Bloco 4 — Demonstração & Resultados</div>
                        <div class="title">Evidência 2: Pendência — Falta Documento Oficial com Foto</div>
                    </div>
                </div>
                <div class="member-badge">Equipe Integrada</div>
            </div>
            ...
            <div class="footer">
                <span>Empresa Portal Fake — Processo 1</span>
                <span>Slide 20 de 23</span>
            </div>
        </div>

        <!-- SLIDE 21: EVIDÊNCIA 3 - PENDÊNCIA: FALTA COMPROVANTE -->
        <div class="slide">
            <div class="header">
                <div class="header-title-box">
                    <div class="red-bar"></div>
                    <div>
                        <div class="category">Bloco 4 — Demonstração & Resultados</div>
                        <div class="title">Evidência 3: Pendência — Falta Comprovante de Residência</div>
                    </div>
                </div>
                <div class="member-badge">Equipe Integrada</div>
            </div>
